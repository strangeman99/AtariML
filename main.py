from baselines.common.atari_wrappers import make_atari, wrap_deepmind  # having a problem downloading these libraries
import numpy as np
...
def main():
    ...
    model = create_q_model()  # creating a q network
    ...
    while True:  # going until it converges
        ...
        for timestep in range(1, max_steps_per_episode):
            ...
            if frame_count < epsilon_random_frames or epsilon > np.random.rand(1)[0]:
                ...
                action_probs = model(state_tensor, training=False)  # pretty much calculating all of the action probabilities
